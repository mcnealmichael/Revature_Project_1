...
public class Reimbursement_Ticket {
	...
	public Reimbursement_Ticket(String ticket_description, float ticket_amount, String ticket_status) {
		super();
	...
	@Override
	public int hashCode() {
		return Objects.hash(ticket_amount, ticket_description, ticket_status);
	}
	@Override
	...
	public String toString() {
		return "Reimbursement_Ticket [ticket_description=" + ticket_description + ", ticket_amount=" + ticket_amount
